...
public class DocumentTask {
    ...
    /** 便捷构造 */
    public static DocumentTask create(String taskId, String fileName, String filePath, long fileSize) {
        return create(taskId, fileName, filePath, fileSize, null, "PUBLIC");
    }

    public static DocumentTask create(String taskId, String fileName, String filePath,
