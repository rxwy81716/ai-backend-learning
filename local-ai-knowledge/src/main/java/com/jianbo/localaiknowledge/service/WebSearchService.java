 ...
 * 网络搜索服务（当知识库无结果时降级调用）
 *
 * 支持 Tavily API（专为 AI 优化的搜索引擎）
 * 也可替换为 SerpAPI / Bing Search API / Google Custom Search
 *
 * 配置：
 *   app.web-search.provider: tavily / serpapi（默认 tavily）
 *   app.web-search.api-key: 你的 API Key
