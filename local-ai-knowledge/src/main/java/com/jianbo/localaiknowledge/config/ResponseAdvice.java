 ...
 * 全局响应统一处理
 *
 * <p>功能： 1. 将所有返回值统一包装为 { code, message, data } 结构 2. 记录接口响应日志 3. 处理异常响应
 */
@Slf4j
...
public class ResponseAdvice implements ResponseBodyAdvice<Object> {
  ...
  public boolean supports(
    ...
    if (org.springframework.core.io.Resource.class.isAssignableFrom(
  ...
  private Object handleResponseEntity(
      ResponseEntity<?> responseEntity, ServerHttpRequest request, ServerHttpResponse response) {
