...
public interface SystemPromptMapper {
  ...
  @Select(
      "SELECT id, name, content, description, is_default, created_at, updated_at FROM system_prompt WHERE is_default = TRUE LIMIT 1")
  @Results({
  ...
  @Select(
      "SELECT id, name, content, description, is_default, created_at, updated_at FROM system_prompt WHERE name = #{name}")
  @Results({
    @Result(property = "isDefault", column = "is_default"),
    @Result(property = "createdAt", column = "created_at"),
    @Result(property = "updatedAt", column = "updated_at")
  ...
  @Select(
      "SELECT id, name, content, description, is_default, created_at, updated_at FROM system_prompt ORDER BY is_default DESC, updated_at DESC")
  @Results({
    @Result(property = "isDefault", column = "is_default"),
    @Result(property = "createdAt", column = "created_at"),
    @Result(property = "updatedAt", column = "updated_at")
  ...
  @Select(
      "SELECT id, name, content, description, is_default, created_at, updated_at FROM system_prompt WHERE id = #{id}")
  @Results({
    @Result(property = "isDefault", column = "is_default"),
    @Result(property = "createdAt", column = "created_at"),
    @Result(property = "updatedAt", column = "updated_at")
