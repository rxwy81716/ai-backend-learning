 ...
 * 爬虫热榜数据 Mapper
 *
 * <p>查询 crawler_hot_item 表（由 local-ai-crawler 写入）， 提供每日热榜展示和统计分析查询。
 */
@Mapper
public interface CrawlerHotItemMapper {
  ...
  @Select(
      """
        ...
        ORDER BY rank ASC
    """)
  List<Map<String, Object>> findByDateAndSource(
      @Param("date") LocalDate date, @Param("source") String source);
  ...
  @Select(
    ...
    """)
  List<Map<String, Object>> findByDatePaged(
