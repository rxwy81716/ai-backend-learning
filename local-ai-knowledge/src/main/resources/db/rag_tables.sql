...
-- 插入默认 RAG Prompt
INSERT INTO system_prompt (name, content, description, is_default) VALUES
('rag_default',
...
ALTER TABLE document_task ADD COLUMN IF NOT EXISTS user_id   VARCHAR(64);
ALTER TABLE document_task ADD COLUMN IF NOT EXISTS doc_scope VARCHAR(20) NOT NULL DEFAULT 'PUBLIC';
