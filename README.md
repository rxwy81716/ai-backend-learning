...
### Prompt
``
你是专业AI工程师,springAI专家，按照我前面统一的笔记风格，
帮我查一下 向量相似度语义检索入完整版学习笔记，零基础从0讲解。

内容必须包含：
1. SpringAI 整合，完整可运行Java代码
2. 结合PostgreSQL+pgvector/ES向量检索完整代码
3. 关键代码详细注释、名词通俗解释、面试必背总结

要求：
- 代码完整可直接复制运行
- 结构分层清晰，适合做手写笔记
- 不敷衍、不精简，零基础能看懂
- 衔接上一节：向量存储，下一节对接全链路打通

不要虚假回答和自己理解 不会就说不会 写代码要正确 优先查源码判断
生成文档我自己写 不要改项目中东西  我跟着边学边写
``
## 🎯 目标
